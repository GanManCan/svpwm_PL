...
HD_PWD='C:/Users/Matt/Xilinix_projects/svpwm_PL/svpwm_PL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log svpwm_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source svpwm_top_level.tcl
