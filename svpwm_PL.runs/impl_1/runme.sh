...
HD_PWD='C:/Users/Matt/Xilinix_projects/svpwm_PL/svpwm_PL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log svpwm_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source svpwm_top_level.tcl -notrace
